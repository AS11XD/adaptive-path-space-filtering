...
#define FOURCC_ATI2				0x32495441 //(MAKEFOURCC('2','I','T','A'))
...
int is_compressed_texture(int format) {
	return (format == GL_COMPRESSED_RGBA_S3TC_DXT1_EXT || (format == GL_COMPRESSED_RGBA_S3TC_DXT3_EXT) || (format == GL_COMPRESSED_RGBA_S3TC_DXT5_EXT || (format == GL_COMPRESSED_RG_RGTC2_EXT)));
}
