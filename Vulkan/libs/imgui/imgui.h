...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderScalarRange(const char* label, ImGuiDataType data_type, void* p_data, size_t p_data_count, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalarRange(const char* label, ImGuiDataType data_type, void* p_data, ImU32* colors, size_t p_data_count, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderFloatRange(const char* label, float* v, size_t rangeSliderCount, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloatRange(const char* label, float* v, ImU32* colors, size_t rangeSliderCount, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API void          ColorGradientBar(const char* label, size_t count, ImU32* colors, float* values, const char* format = "%.3f");
    IMGUI_API void          ColorGradientBar(const char* label, size_t count, ImU32* colors, ImU32* values);
