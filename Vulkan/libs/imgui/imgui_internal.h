...
namespace ImGui
{
	...
	IMGUI_API bool          SliderBehaviorRange(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, size_t v_size, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb, size_t* nearestIndex);
	...
	template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  SliderBehaviorRangeT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, T* v_dat, size_t v_size, T v_min, T v_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb, size_t* nearestIndex);
